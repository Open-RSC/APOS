 ...
 */
public final class RcseBotFrame extends Frame {
	...
	RcseBotFrame(final IClientInit clientInit, final TextArea cTextArea, final String account) {
		super("APOS (" + account + ")");
		...
		RSCFrame rscFrame;
		(rscFrame = new RSCFrame()).setPreferredSize(new Dimension(511, 342));
		...
		chooseButton.addActionListener(e -> {
			...
			scriptFrame.setLocationRelativeTo(RcseBotFrame.this);
		...
		debugButton.addActionListener(e -> {
			...
			debugFrame.setLocationRelativeTo(RcseBotFrame.this);
