...
public final class LocalRouteCalc {
	...
	public int calculate(final int[][] adjacency, final int start_x, final int start_y,
						 final int min_x, final int min_y, final int max_x, final int max_y, final boolean approximate) {
