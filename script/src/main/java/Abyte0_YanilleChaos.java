...
//2023-03-18 - 1.0 Added Cleaning basic herbs and mixing with water when available

public class Abyte0_YanilleChaos extends Abyte0_Script
{
	private final String SCRIPT_VERSION = "1.0 - Mix Basic Herbs to save time";
	...
	int[] priorityItems = {HalfDragonSquareShield1,HalfDragonSquareShield2,sinisterKey,halfKey1,halfKey2, dirtyRanarr, irit, 440, kwuarm, 442, dwarfWeed, 815, 817, 819, 821, 823, 933};

	int[] items = {law,deathRunes,CosmicRune,FireRune,AirRune,WhiteBerries,EarthRune,nature,WaterRune,superDef1, dirtyGuam, dirtyTarromin, dirtyHarralander, groundUnicornHorn, limpwrut, emptyVial, waterVial, unfinishGuam, unfinishTarromin, unfinishHarralander,unfinishRanarr, cleanGuam, cleanTarromin, cleanHarralander, cleanRanarr};
	...
	public int main()
	{
		...
		if(!IsStillHavingFood(foodId) || getInventoryCount() == 30)
		{
