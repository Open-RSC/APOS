...
* Created by AByte0
*/
//2022-01-20 - Version 1.0 - Support multiple buyers without closing the shop + Talk
...
public class Abyte0_TraverlyShop extends Abyte0_Script
{
	...
	public String[] getRandomQuotes()
	{
		String[] result = {
			"Herblaw level?",
			"this dam vial shop is always empty",
			"Buying vials and eyes...",
			"Lets make some potions",
			"Herb lvl?",
			"Are you planning to sell Super set?",
			"My precious vials"};
		return result;
	}

	public Abyte0_TraverlyShop(Extension e)
	{
		super(e);
	}
	...
	public int main()
	{
		...
		if(shopWindowOpen())
		{
			...
			if(getInventoryCount() == 30 || ((getInventoryCount(idVials) + getInventoryCount(idEyes)) == (eyesToBuy + vialsToBuy)))
			{
				closeShop();
				return 2500;
			}
