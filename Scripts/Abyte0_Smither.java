...
{    
	...
	int[] itemToDeposit = new int[]{8,63,67,72,78,84,88,90,95,105,109,114,118,119,121,125,129,225,309,1024,1064,1077};   
	...
	public Abyte0_Smither(Extension e) {super(e);}    
	...
	public void init(String params)
	{
		...
		print("Default = Steel Pl8s || abyte0_smither barID,nbBars,nbBarsParItems,reponse1,reponse2,reponse3,nbReponses");               
		print("Param = " + params);
	}    
