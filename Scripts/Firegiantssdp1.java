...
public class Firegiantssdp1 extends Abyte0_Script
{
  ...
  public int main()
  {
    ...
    if ((isBanking()) && (this.bankingnow) && (!this.walkingnow) && (!this.fightingnow))
    {
      ...
      if (getInventoryCount(new int[] { 1277 }) > 1)
      {
        this.dsq += getInventoryCount(new int[] { 1277 });
        deposit(1277, getInventoryCount(new int[] { 1277 }) - 1);
...
if (getInventoryCount(new int[] { 497 }) > 1)
      {
        deposit(497, getInventoryCount(new int[] { 497 }) - 1);
        return random(1000, 1500);
      }
      if (getInventoryCount(new int[] { 497 }) < 1)
      {
...
//walkTo(659,3288);
    ...
    if ((!this.bankingnow) && (!this.walkingnow) && (this.fightingnow))
    {
      ...
      if (getInventoryCount(new int[] { 546 }) == 30) 
      {
        ...
        useItem(getInventoryIndex(new int[] { 497 }));
        return random(300, 400);
      }
      if (getInventoryCount(new int[] { 497 }) > 0)
      {
        if (inCombat())
        {
          walkTo(getX(), getY());
 ...
 if (getInventoryCount(new int[] { 546 }) == 30)
  ...
  if (getInventoryCount(new int[] { 546 }) == 30)
      ...
      arrayOfInt1 = getItemById(new int[] { 795 });
      if (arrayOfInt1[0] != -1)
      {
      ...
      arrayOfInt2 = getItemById(new int[] { 1277 });
      if (arrayOfInt2[0] != -1)
      {
      ...
      int[] arrayOfInt3 = getItemById(new int[] { 93 });
      if (arrayOfInt3[0] != -1)
      {
      ...
      int[] arrayOfInt4 = getItemById(new int[] { 408 });
      if (arrayOfInt4[0] != -1)
      {
      ...
      int[] arrayOfInt5 = getItemById(new int[] { 619 });
      if (arrayOfInt5[0] != -1)
      {
      ...
      int[] arrayOfInt7 = getItemById(new int[] { 526 });
      if (arrayOfInt7[0] != -1)
      {
      ...
      int[] arrayOfInt8 = getItemById(new int[] { 527 });
      if (arrayOfInt8[0] != -1)
      {
      ...
      int[] arrayOfInt9 = getItemById(new int[] { 413 });
      if (arrayOfInt9[0] != -1)
      {
      ...
      int[] arrayOfInt13 = getItemById(new int[] { 398 });
      if (arrayOfInt13[0] != -1)
      {
      ...
      int[] arrayOfInt14 = getItemById(new int[] { 403 });
      if (arrayOfInt14[0] != -1)
      {
      ...
      int[] arrayOfInt15 = getItemById(new int[] { 1092 });
      if (arrayOfInt15[0] != -1)
      {
...
int[] arrayOfInt16 = getItemById(new int[] { 405 });
      if (arrayOfInt16[0] != -1)
      {
...
int[] arrayOfInt18 = getItemById(new int[] { 223 });
      if (arrayOfInt18[0] != -1)
      {
...
int[] arrayOfInt19 = getItemById(new int[] { 81 });
      if (arrayOfInt19[0] != -1)
      {
