  ...
  public int main()
   {
     ...
     if (isBanking())
     {
        if (getInventoryCount(new int[] { this.dropIDs2 }) >0)
       {
         deposit(this.dropIDs2, getInventoryCount(new int[] { this.dropIDs2 }));
         return random(1500, 2000);
       }
         
       if (getInventoryCount(new int[] { this.item }) == 9 && getInventoryCount(464) == 9&& getInventoryCount(new int[] { this.dropIDs }) == 9)
       {
         closeBank();
         return 500;
       }
       ...
       if (getInventoryCount(new int[] { this.item }) < 9)
       {
         withdraw(this.item, 9-getInventoryCount(new int[] { this.item }));
         return random(1450, 1500);
       }
       if (getInventoryCount(new int[] { this.item }) >9)
       {
         deposit(this.item, getInventoryCount(new int[] { this.item })-9);
         return random(1500, 2000);
       }
       
       
       if (getInventoryCount(new int[] { this.dropIDs }) < 9)
       {
         withdraw(this.dropIDs, 9 - getInventoryCount(new int[] { this.dropIDs }));
         return random(1450, 1500);
       }
      }
     ...
     if (getInventoryCount(new int[] { this.item }) > 0)
     {
       useItemWithItem(getInventoryIndex(new int[] { this.item }),   getInventoryIndex(464));
       return random(250, 300);
     }
     if (getInventoryCount(new int[] { this.item2 }) > 0)
     {
       useItemWithItem(getInventoryIndex(new int[] { this.dropIDs }),   getInventoryIndex(new int[] { this.item2 }));
       return random(250, 300);
     }
