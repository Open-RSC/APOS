...
public final class S_EdgevilleGiants extends Script {
	...
	private final int w_food_count = 20;

	// Bank on full inv?
	private final boolean bank_full = false;
	...
	public int main() {
		...
		int item__ = countPlayers();
		for (int item___ = 0; item___ < item__; ++item___) {
			if (item_.equals(getPlayerName
				(item___)
