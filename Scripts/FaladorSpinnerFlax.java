...
public final class FaladorSpinnerFlax extends Script {
    ...
    private static final int WOOL = 675;
    private static final int WOOL_BALL = 676;
    ...
    public int main() {
        ...
        if (sleep_time != -1L || getFatigue() > 95) {
